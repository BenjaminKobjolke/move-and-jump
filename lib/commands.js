...
export const COMMANDS = [
  ...
  // Open a link from the displayed message in the default browser. Two levels
  // deep as well: the completed name lists the message's links.
  { name: "links", takesArg: true },
  // Act on the displayed message and close the popup. `messageAction` marks
  // them for the popup, which runs them through background.js.
  { name: "copy-name", messageAction: true },
  { name: "copy-email", messageAction: true },
  { name: "write", messageAction: true },
  { name: "reply", messageAction: true },
  { name: "reply-all", messageAction: true },
];
